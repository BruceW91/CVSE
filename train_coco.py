...
def main():
    ...
    parser.add_argument('--inp_name', default='data/coco_annotations/Concept_annotations/coco_concepts_glove_word2vec.pkl',
                        help='load the input glove word embedding file')
    parser.add_argument('--adj_file', default='data/coco_annotations/Concept_annotations/coco_adj_concepts.pkl', help='load the adj file')
