...
def main():
    ...
    parser.add_argument('--attribute_path',
                        default='data/coco_annotations/Concept_annotations_coco/',
    ...
    parser.add_argument('--inp_name', default='data/coco_annotations/Concept_annotations_coco/coco_concepts_glove_word2vec.pkl',
                        help='load the input glove word embedding file')
    parser.add_argument('--adj_file', default='data/coco_annotations/Concept_annotations_coco/coco_adj_concepts.pkl', help='load the adj file')
    ...
    parser.add_argument('--lr_MLGCN_update', default=10, type=int,
                        help='Number of epochs to update the learning rate.')
    parser.add_argument('--Concept_label_ratio', default=0.4, type=float, help='The ratio of concept label.')
...
def validate(opt, val_loader, model):
    ...
    img_embs, cap_embs, img_emb_cons, cap_emb_cons, completion_labels = encode_data_KNN_rerank(model=model, data_loader=val_loader,
                                                                                             index_KNN_neighbour=ind_cap_complete, 
                                                                                             concept_labels=concept_labels, alpha=alpha)
